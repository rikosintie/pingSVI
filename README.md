...
## Example of a port map

This is created by one of the Helper scripts from the Discovery project, `port-map.py`, located in the [Discovery Repository](https://rikosintie.github.io/Discovery/Helper-scripts).
...
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.223     000c29-e0a4db        2              VMware           ubuntu-server          
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.254     085b0e-7c7930        2              Fortinet         Fortigate-VM          
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.139     2428fd-28ae26        2              HikvisionDig     nvr                    
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.113     2a3872-30e7ae        2              Randomized       MacBookAir             
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.136     34a8eb-28ed42        2              Apple            Troys-iPad             
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.147     3ca9f4-bf2ae4        2              Intel            Precision-M6800        
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.108     446755-03d472        2              OrbitIrrigat     espressif              
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10,30,60   No-Match           f87b20-34a381        2              Cisco                                   
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.253     f87b20-34a3c6        2              Cisco            3850                   
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.50      fcecda-c46e55        2              Ubiquiti         Ubiquiti-office        
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.51      fcecda-c4770b        2              Ubiquiti         Ubiquiti-garage        
──────────────────────────────────────────────────────────────────────────────────────────────────────────
20         192.168.20.145     3817c3-c920c2        3              HewlettPacka     Garage-325             
──────────────────────────────────────────────────────────────────────────────────────────────────────────
10         192.168.10.107     f83002-36a609        3              TexasInstrum     HALO-GAUX-BB           
──────────────────────────────────────────────────────────────────────────────────────────────────────────
20         192.168.20.188     d8d43c-651b3e        4              Sony             Cam-Camper             
──────────────────────────────────────────────────────────────────────────────────────────────────────────
20         192.168.20.180     fcf152-6058fa        7              Sony             Cam-Garage-Right       
──────────────────────────────────────────────────────────────────────────────────────────────────────────
20         192.168.20.182     d8d43c-2e4bcb        8              Sony             Cam-Garage-Center                       
──────────────────────────────────────────────────────────────────────────────────────────────────────────
20         192.168.20.185     d8d43c-651c6b        9              Sony             Cam-Front-Porch  
```
